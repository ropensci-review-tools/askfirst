...
- [ ] T028-1: In `agent-hooks/manifest.json`, change `"hook_version": 4` to
...
- [ ] T028-2: In `agent-hooks/generate-install-hooks.sh`, add a new step in
...
- [ ] T028-3: Run `bash agent-hooks/generate-install-hooks.sh` once. Confirm
...
- [ ] T028-4: In `bindings/r/tests/testthat/test-init.R`, change both
...
- [ ] T028-5: Run `grep -rn "askfirst-hook-version: [0-9]" .` (excluding
