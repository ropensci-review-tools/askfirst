...
- [ ] T026-1: Create `.github/workflows/test.yml`. Name it `Full test suite`.
...
- [ ] T026-2: In `.github/workflows/test.yml`, add a second job,
...
- [ ] T026-3: Delete `.github/workflows/test-install.yml` now that its
...
- [ ] T026-4: Sanity-check `.github/workflows/test.yml` for correctness
  before committing:
