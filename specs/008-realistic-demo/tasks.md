...
- [ ] T008-1: In `bindings/r/vignettes/askfirst-development.Rmd`, add a new
...
- [ ] T008-2: Replace the `R/tokenpkg.R` code block in the vignette to:
...
- [ ] T008-3: Add `export(tokenpkg_parse_version)` to the NAMESPACE code
...
- [ ] T008-4: Update the four verification paragraphs in Step 2 (Claude Code)
...
- [ ] T008-5: In Step 3 (opencode), update the reference to "the same four
...
- [ ] T008-6: Run `devtools::check("bindings/r")` to confirm the vignette
