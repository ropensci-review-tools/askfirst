#' pkghooks: Detect and Redirect LLM/AI-Agent Callers
#'
...
#' capability.
#'
#' Call [pkghooks_init()] once from your own package's `.onLoad()`, and
#' call [flag_capability_gap()] inline at any point your own code
